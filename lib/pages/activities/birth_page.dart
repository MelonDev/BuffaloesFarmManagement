...
class BirthPage extends StatefulWidget {
  const BirthPage({super.key, required this.buffId});
        ...
        child: Form(
          child: ListView(
            ...
            children: <Widget>[
              ...
              textHeader(title: "ผลการคลอด"),
              tabBar(
                initialValue: result,
                children: {
                  0: buildSegment("คลอดสำเร็จ", 0, result),
                  1: buildSegment("แท้ง", 1, result),
                },
                callback: (value) {
                  setState(() {
                    result = value;
